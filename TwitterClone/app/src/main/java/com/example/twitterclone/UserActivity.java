                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    tweet.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            if (e == null) {
                                Toast.makeText(UserActivity.this, "Tweet sent!", Toast.LENGTH_SHORT);
                            } else {
                                Toast.makeText(UserActivity.this, "Tweet failed :(", Toast.LENGTH_SHORT);
                            }
                        }
                    });
                }
